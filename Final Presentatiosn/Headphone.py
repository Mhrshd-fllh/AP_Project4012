...
def Get_Product(Product_Name, Product_Version, Product_Connection, Product_USBPort, Product_Battery, Product_Weight,Product_Digikala,Product_TechnoLife,Product_MeghdadIT, Product_Page):
    Details = []
