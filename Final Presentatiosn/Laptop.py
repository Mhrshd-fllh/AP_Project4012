...
def Get_Product(Product_Name, Product_RAM, Product_Storage, Product_CPU, Product_USB_Port, Product_Battery ,Product_Size,Product_Weight,Product_Digikala, Product_TechnoLife, Product_MeghdadIT, Product_Page):
    Details = []
    Details.append(Product_Name)
    Details.append(Product_RAM)
    Details.append(Product_Storage)
    Details.append(Product_CPU)
    Details.append(Product_USB_Port)
